...
exports.run = async () => {
  ...
  server.on('message', async (msg) => {
    ...
    try {
      ...
      const promLabels = { cacheStatus: body.cacheStatus, operationId: body.operation.id, statusClass: body.status.class, host: body.host, refererDomain: body.refererDomain }
